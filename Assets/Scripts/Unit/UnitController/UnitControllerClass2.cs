...
{
    public class UnitControllerClass2 : MonoBehaviour
    {
    [SerializeField] private List<GameObject> buttons;
        ...
        {
            BusSystem.OnIncreaseCompletedUnitValueClassThree += IncreaseLevelCompletedCount;
        ...
        private void SetLockImage()
        {
            ...
            for (int i = 0; i < buttons.Count; i++)
            {
                ...
                {
                    buttons[i].GetComponent<ClassMenuControllerThreeClass>().LockGameObject.SetActive(false);
                }
            } 
